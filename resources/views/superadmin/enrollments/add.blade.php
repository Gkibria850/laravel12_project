...
<div class="col-md-12 mt-4">
    <div class="card p-4">
        ...
        <div class="d-flex align-items-center justify-content-between mb-3">
            <h5 class="mb-0">Add Enrollments</h5>
        </div>

        <form action="{{ url('superadmin/enrollments/add') }}" method="POST">
            @csrf
               ...
               <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="enrollment_date" value="{{ old('enrollment_date') }}" required>
