            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="time" class="form-control" id="start_time" name="start_time" value="{{ old('start_time') }}" placeholder="Enter start_time" required>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="time" class="form-control" id="end_time" name="end_time" value="{{ old('end_time') }}" placeholder="Enter Your Roll Number" required>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input name="room_number" type="text" value="{{ old('room_number') }}" placeholder="Enter room_number" class="form-control" required />
